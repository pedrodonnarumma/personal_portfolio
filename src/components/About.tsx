...
const About = ({ language }: AboutProps) => {
  return (
    <section 
      id="about" 
      className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 px-4"
    >
      <div className="max-w-4xl w-full">
        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-600/40 rounded-lg shadow-xl p-6 sm:p-8 hover:border-gray-500/60 transition-all duration-300">
