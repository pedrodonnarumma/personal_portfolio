...
const Hero = ({ language }: HeroProps) => {
  ...
  return (
    <section 
      id="hero" 
      className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 relative"
    >
      <div className="text-center px-4 sm:px-6">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 max-w-md mx-auto">
          <a 
            href="https://github.com/pedrodonnarumma" 
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-all duration-300 font-semibold border border-gray-700 hover:border-gray-600 hover:scale-105 w-full sm:w-auto"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-300 font-semibold border border-blue-500 hover:border-blue-400 hover:scale-105 w-full sm:w-auto"
          >
